...
function runOpMode() {
  ...
  MainArmRight.setDualTargetPosition(-3751, MainArmLeft, -3751);
  ...
  if (linearOpMode.opModeIsActive()) {
    ...
    MainArmRight.setDualMode("RUN_TO_POSITION", MainArmLeft, "RUN_TO_POSITION");
    MainArmRight.setDualTargetPosition(3518, MainArmLeft, 3518);
    ...
    LFdrive.setDualPower(-0.75, RFdrive, 0.75);
    linearOpMode.sleep(1500);
    while (!(linearOpMode.isStopRequested() || GyroSensor.getHeading() >= 180)) {
      telemetry.update();
    }
    LBdrive.setDualPower(0, RBdrive, 0);
    LFdrive.setDualPower(0, RFdrive, 0);
